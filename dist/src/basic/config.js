...
var books = require("../public/db.json");
...
app.get("/books", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, res.json(books)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
app.get("/books/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, res.json(books.find(function (book) { return book.id === req.params.id; }))];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
app.post("/books", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, books.push(req.body)];
            case 1:
                _a.sent();
...
app.put("/books/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                updateIndex = books.findIndex(function (book) { return book.id === req.params.id; });
                console.log(updateIndex);
                return [4 /*yield*/, res.json(Object.assign(books[updateIndex], req.body))];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
app["delete"]("/books/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                deleteIndex = books.findIndex(function (book) { return book.id === req.params.id; });
                return [4 /*yield*/, books.splice(deleteIndex, 1)];
            case 1:
                _a.sent();
                res.status(204).send();
                return [2 /*return*/];
